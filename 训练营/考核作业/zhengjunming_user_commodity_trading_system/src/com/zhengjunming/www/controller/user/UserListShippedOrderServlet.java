 ...
 *
 */
@WebServlet("/UserListShippedOrderServlet")
public class UserListShippedOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			request.getRequestDispatcher("/user/listShippedOrder.jsp").forward(
					request, response);
		} catch (Exception e) {
			e.printStackTrace();
		}
