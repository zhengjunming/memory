 ...
 *
 */
@WebServlet("/UserListReceivedOrderServlet")
public class UserListReceivedOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			request.getRequestDispatcher("/user/listReceivedOrder.jsp")
