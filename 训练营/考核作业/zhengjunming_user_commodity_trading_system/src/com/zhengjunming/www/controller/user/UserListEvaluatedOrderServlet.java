 ...
 *
 */
@WebServlet("/UserListEvaluatedOrderServlet")
public class UserListEvaluatedOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			request.getRequestDispatcher("/user/listEvaluateOrder.jsp")
