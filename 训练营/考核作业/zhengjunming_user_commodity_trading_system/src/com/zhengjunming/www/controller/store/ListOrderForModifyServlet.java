 ...
 *
 */
@WebServlet("/ListOrderForModifyServlet")
public class ListOrderForModifyServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			orders = daoImpl.getOrderForModify(pageSize,
					Integer.parseInt(page), store.getId());
			request.getSession().setAttribute("orders", orders);
			request.getRequestDispatcher("/store/listOrderForModify.jsp")
