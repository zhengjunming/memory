 ...
 *
 */
@WebServlet("/UserListNoShippingOrderServlet")
public class UserListNoShippingOrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			request.getRequestDispatcher("/user/listNoShippingOrder.jsp")
