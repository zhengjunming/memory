 ...
 *
 */
@WebServlet("/ListGoodsForImproveServlet")
public class ListGoodsForImproveServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			goodses = daoImpl.ListNotUnderShelvedGoods(pageSize,
					Integer.parseInt(page), store);
			request.setAttribute("goodses", goodses);
			request.getRequestDispatcher("/store/improveGoodsInfoIndex.jsp")
