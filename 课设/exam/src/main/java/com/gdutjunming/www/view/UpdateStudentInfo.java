 ...
 */
class UpdateStudentInfo extends MainMenu {
    /**
     * 学号输入文本框
     */
    ...
    UpdateStudentInfo(Student student2) {
        ...
        studentIdTextField.setText(String.valueOf(student2.getId()));
        ...
        studentNameTextField.setText(student2.getStudentName());
        ...
        classTextField.setText(student2.getaClass().getClassName());
        ...
        chineseScoreTextField.setText(String.valueOf(student2.getChineseScore()));
        ...
        mathScoreTextField.setText(String.valueOf(student2.getMathScore()));
        ...
        englishScoreTextField.setText(String.valueOf(student2.getEnglishScore()));
        ...
        cancelButton.addActionListener(e -> {
            int result = JOptionPane.showConfirmDialog(null, "确认取消修改吗?", "提示信息", JOptionPane.YES_NO_OPTION);
